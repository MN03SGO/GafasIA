...
class Camera:
    def __init__(self, device_id: Optional[int] = None):
        self.device_id = device_id or config.get('camara.id_dispositivo', 0)
        self.width = config.get('camara.ancho', 640)
        self.height = config.get('camara.alto', 480)
        self.fps = config.get('camara.fps', 30)
